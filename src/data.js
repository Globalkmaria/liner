export const detail_data = [
  ...
  },
  {
    ...
    liner_highlight: `The way I build MOC's with the [[tags]] links that don't exist mean I don't need to manage/track anything in regards to promoting a [[tag]] to a MOC I can just see a big red node on my graph, it's VISUALLY apparent`,
...
export const more_like_this = [
  ...
  {
    id: 3,
    description: 'How do you export an outline of actions to Omni Outliner ...',
    linkimg: '',
    link: 'www.outlinersoftware.com',
  },
];
